...
public class DefaultButton extends CustomButton {
	...
	public DefaultButton(int x, int y, int widthIn, int heightIn, String buttonText, Button.OnPress onPress) {
	...
	public DefaultButton(int x, int y, int widthIn, boolean visibility, String buttonText, Button.OnPress onPress) {
