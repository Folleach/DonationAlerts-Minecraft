...
public class CustomTextBox extends Gui {
    ...
    public int LineColor = Pallete.GRAY30_TRANSPERIENTDD;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            if (this.getEnableBackgroundDrawing())
            {
                ...
                drawRect(x, y, x + width, y + height, Pallete.GRAY12_TRANSPERIENTDD);
                drawRect(x, y + height - 1, x + width, y + height, lineColor);
            }
            if (tag != null)
